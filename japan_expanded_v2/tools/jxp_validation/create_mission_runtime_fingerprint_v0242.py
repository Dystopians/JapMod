...
def render() -> str:
    ...
    house_anchors = tuple(anchor for _trigger, anchor in DAIMYO_HOUSES)
    ...
    lines = [
        ...
        "\tOR = {",
        *_assignment_lines(VANILLA_ANCHORS, 2),
        "\t}",
        "}",
        "",
...
def main() -> int:
    ...
    print(f"Created {output}: {len(VANILLA_ANCHORS)} legacy anchors, {len(ROUTE_PROFILES)} route profiles.")
    return 0
