...
PRESSURE_VARIABLE = "jxp_74_ijp_pressure"
...
jxp_74_ijp_pressure_at_least_10_trigger = {
    check_variable = { which = jxp_74_ijp_pressure value = 10 }
}
jxp_74_ijp_pressure_at_least_50_trigger = {
    check_variable = { which = jxp_74_ijp_pressure value = 50 }
}
jxp_74_ijp_pressure_at_least_70_trigger = {
    check_variable = { which = jxp_74_ijp_pressure value = 70 }
}
jxp_74_ijp_pressure_at_least_85_trigger = {
    check_variable = { which = jxp_74_ijp_pressure value = 85 }
}
"""
)
...
def _check_disaster_isolation(
    ...
    contract_ok = all(
        (
            _negative(ikko_potential, "jxp_has_any_route_trigger", "yes"),
            _negative(ikko_potential, "tag", "IJP"),
    ...
    if not contract_ok:
        result.add(
            ...
            "Ikko rising or Shimabara lost the false-positive gates consumed by the IJP loop",
